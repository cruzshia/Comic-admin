...
import { validDateTime, required, validPositiveInteger, composeValidators } from '@src/utils/validation'
...
export function validateCoinProduct(values: Partial<CoinProduct>) {
  return {
    ...
    [CoinProductKeys.PayCoin]: composeValidators(required, validPositiveInteger)(values[CoinProductKeys.PayCoin]),
