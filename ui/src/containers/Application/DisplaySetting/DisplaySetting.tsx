...
import { mockSettingList, mockSettingTotal } from './mockData/mockSetting'

export default function DisplaySetting() {
  return (
    <Switch>
      <DisplaySettingContext.Provider value={{ settingList: mockSettingList, settingTotal: mockSettingTotal }}>
