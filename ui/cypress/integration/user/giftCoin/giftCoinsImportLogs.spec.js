context('Gift Coins Import Logs', () => {
  const targetRoute = '/#/user/gift_coins/batch_logs'
  const pageTitle = 'CSV一括贈答（コイン）ログ'
  ...
  it('Click tab route correctly', function() {
    ...
    cy.findAllByTestId(this.testIds.sidebarTab)
      .contains(this.tabs.giftCoins.id)
      .click()
  ...
  it('Shows correct page title and breadcrumb', function() {
    ...
    cy.findByTestId(this.testIds.breadcrumbs).should(
      'have.text',
      `${this.tabs.user}>${this.tabs.giftCoins.creation}>${pageTitle}`
    )
    cy.findByTestId(this.testIds.breadcrumbLink).should('have.attr', 'href', '#/user/gift_coins/creation')
  })
